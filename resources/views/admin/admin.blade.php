      ...
      <div class="card border-left-success shadow h-100 py-2">
        <div class="card-body">
          <div class="row no-gutters align-items-center">
            ...
            <div class="col-auto">
              <i class="fas fa-fw fa-cheese fa-2x text-gray-300"></i>
            </div>
          </div>
        </div>
      </div>
        ...
        <div class="card-body">
          <div class="row no-gutters align-items-center">
            <div class="col mr-2">
              ...
              <div class="row no-gutters align-items-center">
                <div class="col-auto">
                  <div class="h5 mb-0 mr-3 font-weight-bold text-gray-800">{{ \App\Order::sum('grand_total') }}</div>
                </div>
        ...
        <div class="card-body">
          <div class="row no-gutters align-items-center">
            <div class="col mr-2">
              ...
              <div class="h5 mb-0 font-weight-bold text-gray-800">{{ \App\Order::count() }}</div>
            </div>
            <div class="col-auto">
    ...
    @foreach($users as $user)
      <h4>
        <span class="badge badge-info" 
            style="width: 100%;text-align: left;font-size: 22px;border-left: 4px solid #198aff;padding: 10px;">
          {{ $user->name }} has paid Rs. {{ $user->grand_total }}
        </span>
      </h4>
    @endforeach
    </div>
